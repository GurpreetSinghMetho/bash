...
public class AddSpotufyImagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AddSpotufyImagesAdapter(Context mContext, List<SpotifyListPOJO.Item> list, SpotifyListPOJO pojo1) {
